...
# Use /tmp for uploads on Vercel/serverless as the normal filesystem is read-only
UPLOAD_FOLDER = '/tmp' if (os.getenv("VERCEL") or os.getenv("DATABASE_URL")) else 'uploads'
